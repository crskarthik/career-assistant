...
?>
<html>
<center><h2 style="background-color:white;">Ideasonline_Analysis</h2></center>
  <head>
...
$REGNO="11119A000";
#$sql=mysql_query("SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE table_name='ug'");
