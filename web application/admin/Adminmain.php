        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              <img data-src="desk.jpg" class="img-responsive" alt="200x200" src="desk.jpg" data-holder-rendered="true">
              <h4>Live Session</h4>
              <span class="text-muted">Last Minute Tips & Tricks to crack GATE</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img class="img-responsive" alt="200x200" src="city.jpg" data-holder-rendered="true">
              <h4>TEXAS INSTRUMENTS</h4>
              <span class="text-muted">TEXAS INSTRUMENTS hiring Analog Design Engineer</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img class="img-responsive" alt="200x200" src="abc.jpg" data-holder-rendered="true">
              <h4>Department of Computer Science and Engineering</h4>
              <span class="text-muted">Course Schedule & Fee Details</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img class="img-responsive" alt="200x200" src="5008-office-modern-office-interior-design-with-plain-white-table-and-1920x1080.jpg" data-holder-rendered="true">
              <h4>Department of Computer Science and Engineering</h4>
              <span class="text-muted">A Certification Course on

“PARALLEL  PROGRAMMING  WITH NVIDIA GPU”</span>
            </div>
          </div>
