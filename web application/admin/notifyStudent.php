...
?></span>
         ...
         <legend>Add New Notification</legend>
      <form class="form-horizontal" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data" role="form">    
 <div class="form-group"> 
      <label for="Notifcation" class="col-sm-3 control-label"><h4>Notification About:</h4></label>       
    <div class="col-sm-8">          
   <div id="content">
      <select id="about" name="about" class="form-control">
      <option value="College News">News</option>
      <option value="Placement Cell">Placement</option>
 ...
 <div class="form-group"> 
      <label for="Notifcation" class="col-sm-3 control-label"><h4>Notification:</h4></label>       
    <div class="col-sm-8">          
   <div id="content">
        <textarea id="txt" name="Notification" class="form-control" rows="10"></textarea>
    </div>         
    </div>   
    </div>
    <br/>
    <div class="col-md-offset-3 col-md-5">    
<button class="btn btn-block btn-primary" name="notify" value="submit"> Publish Notification</button>
</div>
</form>
...
<?php
if (isset($_POST['notify'])&&$_POST['notify']=="submit") {
  $notify=mysql_escape_string($_POST['Notification']);
  $about=$_POST['about'];
  echo "<center>".$notify."</center>";
if(count($notify)!=0){
$notificationStatus=mysql_query("INSERT INTO notification_client (`NOTIFICATION`,`ABOUT`) VALUES ('$notify','$about')")or die(mysql_error());
